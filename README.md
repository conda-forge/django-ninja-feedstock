...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-ninja-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14947&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-ninja-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-ninja` can be installed with:

```
conda install django-ninja
```

It is possible to list all of the versions of `django-ninja` available on your platform with:
