...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-ninja-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-ninja-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-ninja
# for installing globally
pixi global install django-ninja
```
...
It is possible to list all of the versions of `django-ninja` available on your platform:
...
```
pixi search django-ninja --channel conda-forge
```
